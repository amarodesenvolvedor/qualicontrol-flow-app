...
// Updating this type to exclude 'code' since it's generated automatically by the database
...
export const useNonConformances = () => {
  ...
  const createNonConformance = useMutation({
    mutationFn: async (nonConformance: NonConformanceInput) => {
      ...
      // Use .insert() without specifying 'code', as it's auto-generated by the database trigger
      const { data, error } = await supabase
        .from("non_conformances")

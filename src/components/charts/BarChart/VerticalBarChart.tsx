...
export const VerticalBarChart = ({ 
  ...
  // Standard margins for vertical charts - increase bottom margin for the rotated labels
  const margins = { top: 20, right: 30, left: 20, bottom: 80 };
  ...
  return (
    <div className="overflow-x-auto">
      <ResponsiveContainer 
        width={data.length > 5 ? Math.max(600, data.length * 100) : '100%'} 
        height={height} 
